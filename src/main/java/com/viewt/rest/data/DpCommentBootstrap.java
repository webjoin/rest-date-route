...
public class DpCommentBootstrap extends BaseBootstrap {
    ...
    protected void crawl(String[] args) {
        ...
        */
        String[] dpIds = Cons.Dianping.DP_WANG_XIANG_YUAN_IDS;
        dpIds = Cons.Dianping.DP_GE_LAO_GUAN_IDS;
    ...
    private void collectComment(String dpId){
        int page = 1;
        int totalPage = 0;
        String shopName = "";
        do {
            ...
            String url = MessageFormat.format(Cons.Dianping.DP_COMMENT_URL, dpId, page);
